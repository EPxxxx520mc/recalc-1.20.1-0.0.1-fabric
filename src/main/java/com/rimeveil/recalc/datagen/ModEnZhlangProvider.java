...
public class ModEnZhlangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("hud.recalc.ability_title", "能力输出");
        translationBuilder.add("hud.recalc.ability_current", "当前能力值：%s");
        translationBuilder.add("hud.recalc.ability_capacity", "能力上限：%s");
        translationBuilder.add("hud.recalc.ability_charge", "可用输出：%s%%");
        translationBuilder.add("hud.recalc.ability_state", "系统状态：%s");
        translationBuilder.add("hud.recalc.ability_state.full", "最佳");
        translationBuilder.add("hud.recalc.ability_state.stable", "稳定");
        translationBuilder.add("hud.recalc.ability_state.low", "低输出");
