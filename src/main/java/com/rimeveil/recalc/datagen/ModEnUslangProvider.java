...
public class ModEnUslangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("hud.recalc.ability_title", "Ability Output");
        translationBuilder.add("hud.recalc.ability_current", "Current Value: %s");
        translationBuilder.add("hud.recalc.ability_capacity", "Output Limit: %s");
        translationBuilder.add("hud.recalc.ability_charge", "Available Output: %s%%");
        translationBuilder.add("hud.recalc.ability_state", "System State: %s");
        translationBuilder.add("hud.recalc.ability_state.full", "Optimal");
        translationBuilder.add("hud.recalc.ability_state.stable", "Stable");
        translationBuilder.add("hud.recalc.ability_state.low", "Low Output");
